...
final class DemoModeHelper {
    ...
    @TargetApi(M)
    private static void showDemoModeSetting23(final Activity activity,
        ...
        new AsyncTask<Void, Void, DemoModeAvailability>() {
            @Override
            protected DemoModeAvailability doInBackground(Void... params) {
            ...
            @Override
            protected void onPostExecute(DemoModeAvailability demoModeAvailability) {
