 ...
 * is already default platform behavior for icon-only [android.app.ActionBar] items and tabs.
...
internal object CheatSheet {
     ...
     * the view's [content description][View.getContentDescription] will be
    ...
    private fun showCheatSheet(view: View, text: CharSequence): Boolean {
        ...
        if (showBelow) {
            ...
            cheatSheet.setGravity(Gravity.TOP or Gravity.CENTER_HORIZONTAL, viewCenterX - screenWidth / 2,
